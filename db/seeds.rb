...
farmer_product = FarmerProduct.create([{farmer_id: 1, product_id: 1, quantity: 5, price: 2}])
...
Product.create([{name:"Celery", description:"Eat too much and they're poisonous!", picture:"https://cdn.saveourbones.com/wp-content/uploads/celery-osteoporosis1.jpg"}])
