...
Product.create([{name:"Tomatoes", description:"Because the tomato has seeds and grows from a flowering plant botanically it is classed as a fruit not a vegetable.", picture:"http://imgur.com/cCyFevh.jpg"}])
...
farmer_product = FarmerProduct.create([{farmer_id: 7, product_id: 10, quantity: 25, price: 2.25}])
